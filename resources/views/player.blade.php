<section class="d-flex align-items-center justify-content-between player">
    <div class="d-flex align-items-center">
        ...
        <div style="margin-right: 10px;margin-left: 10px;">
            <a>
                <div id="artistDisplay">Artist</div><br><div id="musicDisplay">Music</div>
            </a>
        </div>
        <div style="margin-right: 10px;margin-left: 10px;">
            <a>
    ...
    <div class="w-25 d-flex align-items-center justify-content-between">
        ...
        <a id="pausebtn" onclick="pause()" style="display: none;" >
